...
#   RU_gadm <- gadm(country = "RUS", level = 0, path = gadm_path)
# } else {
#   RU_gadm <- readRDS(paste0(gadm_path, "gadm41_RUS_1.rds"))
# }
# #
# if (!file.exists(paste0(gadm_path, "gadm41_RUS_1.rds"))) {
#   KZ_gadm <- gadm(country = "KAZ", level = 0, path = gadm_path)
# } else {
#   KZ_gadm <- readRDS(paste0(gadm_path, "gadm41_RUS_1.rds"))
# }
# #
# if (!file.exists(paste0(gadm_path, "gadm41_RUS_1.rds"))) {
#   CN_gadm <- gadm(country = "CHN", level = 0, path = gadm_path)
# } else {
#   CN_gadm <- readRDS(paste0(gadm_path, "gadm41_RUS_1.rds"))
# }
# #
# if (!file.exists(paste0(gadm_path, "gadm41_RUS_1.rds"))) {
#   MN_gadm <- gadm(country = "MNG", level = 0, path = gadm_path)
# } else {
...
# plot(KZ_c, border = 'black',lwd = 0.5, col = NA,add = T)
# plot(MN_c, border = 'black',lwd = 0.5, col = NA,add = T)
# plot(CN_c, border = 'black',lwd = 0.5, col = NA,add = T)
# }
# #
